...
Open [http://localhost:5000](http://localhost:5000) (leave running).
...
Open [http://localhost:9696/docs](http://localhost:9696/docs)
...
1. Execute → Response shows `duration` and `model_version`.
...
- MLflow UI: inspect runs & artifacts at [http://localhost:5000](http://localhost:5000).
